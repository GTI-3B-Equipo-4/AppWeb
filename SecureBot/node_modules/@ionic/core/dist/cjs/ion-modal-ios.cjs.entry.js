...
const Modal = class {
    ...
    async dismiss(data, role) {
        ...
        const iosAni = (this.animation === undefined || (role === overlays.BACKDROP || role === undefined)) ? iosLeaveAnimation : undefined;
        const enteringAnimation = overlays.activeAnimations.get(this) || [];
        const dismissed = await overlays.dismiss(this, data, role, 'modalLeave', iosAni, mdLeaveAnimation, this.presentingElement);
        if (dismissed) {
    ...
    render() {
        const mode = core.getIonMode(this);
        return (core.h(core.Host, { "no-router": true, "aria-modal": "true", class: Object.assign({ [mode]: true, [`modal-card`]: this.presentingElement !== undefined }, theme.getClassMap(this.cssClass)), style: {
